  ...
  fetch(url)
    ...
    .then(function (d) {
      ...
      el.style.cssText =
        ...
        "text-align:center;padding:14px 20px 30px;direction:ltr;" +
        "background:#FBF7EF;border-top:1px solid rgba(28,24,20,.08);";
      el.textContent = isHome
        ? n + " visits so far · " + "\u062a\u0627\u06a9\u0646\u0648\u0646 " + n + " \u0628\u0627\u0632\u062f\u06cc\u062f"
        : n + " views · " + n + " \u0628\u0627\u0632\u062f\u06cc\u062f";

      /* Place it where it is actually visible. On the home page the last
         section is a full-height dark band, so appending to <body> hides it
         below the fold — insert it just ABOVE that band instead. Elsewhere
         drop it right after the footer, else at the end of <body>. */
      var about = document.getElementById("about");
      var footer = document.querySelector("footer");
      if (about && about.parentNode) {
        about.parentNode.insertBefore(el, about);
      } else if (footer) {
